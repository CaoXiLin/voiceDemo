 ...
 * @since 1.0  
 */    
public abstract class TarUtility {    
     ...
     * @throws Exception
     */    
    public static void archive(File srcFile, TarArchiveOutputStream taos,
     ...
     * @throws Exception
     */    
    public static void archiveDir(File dir, TarArchiveOutputStream taos,
                                  String basePath) throws Exception {
     ...
     * @throws Exception
     */    
    public static void archiveFile(File file, TarArchiveOutputStream taos,
     ...
     * @throws Exception
     */    
    public static void dearchiveFile(File destFile, TarArchiveInputStream tais)
            throws Exception {
    ...
    public static File PathToFile(Context context , String name){
    	String path = context.getExternalFilesDir(name).getAbsolutePath();
